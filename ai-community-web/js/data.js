...
const DATA = {
  ...
  VENDORS: [
    ...
    { vendor_id: 9, vendor_name: '萬事通五金行', vendor_no: 'V024', contact_name: '周老闆', contact_phone: '02-2800-1024', contact_email: 'hardware@wanstong.example.com', rating_avg: '4.50', rating_count: 98, service_types: ['11'], service_areas: [{ county_code: '01', district_code: '' }, { county_code: '02', district_code: '' }] },
    { vendor_id: 10, vendor_name: '鮮果園水果行', vendor_no: 'V025', contact_name: '林老闆', contact_phone: '02-2900-1025', contact_email: 'fruit@freshgarden.example.com', rating_avg: '4.70', rating_count: 215, service_types: ['11'], service_areas: [{ county_code: '01', district_code: '' }, { county_code: '02', district_code: '' }, { county_code: '03', district_code: '' }] },
    { vendor_id: 11, vendor_name: '毛孩生活館', vendor_no: 'V026', contact_name: '王店長', contact_phone: '02-3100-1026', contact_email: 'pet@furlife.example.com', rating_avg: '4.80', rating_count: 342, service_types: ['11'], service_areas: [{ county_code: '01', district_code: '' }, { county_code: '02', district_code: '' }, { county_code: '04', district_code: '' }] },
  ],
